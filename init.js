...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Peter';
const subSiteKeywords = `best video to text translation, video translate, ai video genrate, translate youtube video into english, video auto traslate` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = '094f6d1f9b0c414983f2798b2578fe7c'; // 替换为你的API密钥
